...
class win1:
    def __init__(self,root):
        ...
        lbl = Label(F1,text="LOGIN As Admin ", bg=bg_color, fg="gold", font= ("times new roman",30,"bold")).grid(row=0, column=0,padx=80,pady=30)
        ...
        lbl4 = Label(F2, text = "CodewithAJ_GKG@",fg="green",bg="white", font= ("times new roman",10,"italic")).grid(row=2, column=0,padx=10)

        lbl5 = Label(F2, text = "Follow Us On",fg="red",bg="white", font= ("times new roman",15)).place(x=150,y=350,anchor="c")

        lbl6 = Label(F2, text = "Developed by Aditya Jha and Gaurav Kr. Gupta",fg="#4863A0",bg="white", font= ("times new roman",12)).place(x=0,y=440)
...
#        link4.bind("<Button-1>", lambda e: webbrowser.open_new("http://www.twitter.com"))
        ...
        btn_login1 = Button(F1, text="Login as Employee",relief=GROOVE,width =15,height=1, font=("times new roman",14,"bold"),bg="light green",command=self.login3).place(x=480,y=120,anchor="e")
