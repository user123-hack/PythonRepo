...
#----------------------------------------------Images---------------------------------------------------------------------------------------------------------------------
        ...
        self.bg_icon = ImageTk.PhotoImage(file="1222596.jpg")
        bg_lbl = Label(self.root, image = self.bg_icon).pack(fill=Y) # we put image into our window
        self.clock_icon=ImageTk.PhotoImage(file="download (2).png")
        self.student_icon=ImageTk.PhotoImage(file="images (1).jpg")

        #----------------------------------------------------------------

        self.home_icon=ImageTk.PhotoImage(file="Home.png")
        self.mangEmp_icon=ImageTk.PhotoImage(file="Manage_Emp.png")
        self.mangStd_icon=ImageTk.PhotoImage(file="Manage_Stud.png")
        self.ViewStd_icon=ImageTk.PhotoImage(file="View_Stud.png")
        self.viewall_icon=ImageTk.PhotoImage(file="View.jpg")
        
        self.change_pasw_icon=ImageTk.PhotoImage(file="Change_pasw.png")
        self.exit_icon=ImageTk.PhotoImage(file="Exit.png")
...
#----------------------------------------------F1---------------------------------------------------------------------------------------------------------------------
        ...
        self.calendar1.append(DateEntry(F1, font=("times new roman",15,"bold"), locale='en_GB',state="readonly", width=10))
        self.calendar1[-1].place(x=855, y=20, anchor="w")
        #print (self.calendar)
        ...
        lbl2 = Label(F1,text="CodewithAJ_GKG@",font=("times new roman",15),bg=bg_color)
...
#-----------------------------------------------------------------------Main Screen------------------------------------------------------------------------------
        ...
        self.F4 = Frame(self.root,bd=5,relief=FLAT)
        self.F4.place(x=151,y=132,relwidth=1,height=600)
        lbl_1= Label(self.F4,text="Manage Students",fg="#008080",font=("geometric sans-serif",30,"bold"))
        lbl_1.place(x=0,y=0)
        ...
        lbl_roll=Label(self.F4,text="Student ID",font=("times new roman",18,"bold"),bg="#F5F5F5")
        ...
        lbl_roll=Label(self.F4,text="First Name",font=("times new roman",18,"bold"),bg="#F5F5F5")
        ...
        lbl_roll=Label(self.F4,text="Last Name",bg="#F5F5F5",font=("times new roman",18,"bold"))
        ...
        lbl_roll=Label(self.F4,text="Roll No",bg="#F5F5F5",font=("times new roman",18,"bold"))
        ...
        lbl_roll=Label(self.F4,text="Contact",bg="#F5F5F5",font=("times new roman",18,"bold"))
        ...
        #***************************************************************************************************
        lbl_roll=Label(self.F4,text="Class",bg="#F5F5F5",font=("times new roman",20,"bold"))
        ...
        lbl_roll=Label(self.F4,text="Address",bg="#F5F5F5",font=("times new roman",18,"bold"))
        ...
        lb_dep=Label(self.F4,text="Department", font=("times new roman",16,"bold"),bg="#F5F5F5")
        ...
        labels = ('DOB')
        self.label=(Label(self.F4, text="D.O.B",bg="#F5F5F5",  font=self.font))
        ...
        lbl_roll=Label(self.F4,text="Email",bg="#F5F5F5",font=("times new roman",18,"bold"))
        ...
        #***********************************************************************************************
        lb_dep=Label(self.F4,text="Semester", font=("times new roman",18,"bold"),bg="#F5F5F5")
        ...
        #***********************************************************************************************
        lb_dep=Label(self.F4,text="Gender", font=("times new roman",18,"bold"),bg="#F5F5F5")
        ...
        lbl_roll=Label(self.F4,text="Social Links",bg="#F5F5F5",font=("times new roman",18,"bold"))
        ...
        lbl_roll=Label(self.F4,text="Facebook URL",bg="#F5F5F5",font=("times new roman",18,"bold"))
        ...
        lbl_roll=Label(self.F4,text="LinkedIn URL",bg="#F5F5F5",font=("times new roman",18,"bold"))
...
#----------------------------------------------Buttons---------------------------------------------------------------------------------
        ...
        self.txt_roll12=Entry(F5, textvariable=self.dele,width=22, font=("times new roman",13,"bold"),bd=5,relief=GROOVE)
        self.txt_roll12.grid(row=0,column=2,pady=6,padx=5,sticky="nesw")
        btn_Clear = Button(self.F4,relief=GROOVE, width=15,font=("times new roman",13,"bold"),bg="navy blue",fg="yellow",bd=6,text="Clear ALL",command=self.clear).place(x=320,y=440,anchor="w")       
...
#----------------------------------------------------------------FUNCTIONS--------------------------------------------------------
    ...
    def update(self):
        ...
        self.conn=sqlite3.connect("sdms.db")
        self.c=self.conn.cursor()
        self.c.execute("SELECT * from Std WHERE Roll="+str(self.Roll_no.get()))
        ...
        if self.data:
                ...
                y=\
                """UPDATE Std SET Std_ID  =\"""" + self.Std_ID.get()+\
                ...
                self.c.execute(y)
                self.conn.commit()
                return messagebox.showinfo("Error"," Data  Updated")
                self.conn.close()
        else:
    ...
    def delete(self):
        try:
            self.conn=sqlite3.connect("sdms.db")
            self.c=self.conn.cursor()
            self.c.execute("SELECT * from Std WHERE Roll="+str(self.dele.get()))
            self.data=self.c.fetchall()
            if self.data:
                self.c.execute("DELETE FROM Std WHERE Roll = " +self.dele.get())
                self.conn.commit()
                self.conn.close()
